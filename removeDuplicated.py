...
def getCommentsSentiment():
	...
	try:
		...
		query = "SELECT annotationid from comment join annotation on annotation.comment_commentid = comment.commentid where polarity = 'Neutral' and concept = 'Negative feelings'"
