...
dictVocabulary={	
	...
	'Support': {'support':1.0, 'help':0.8, 'service':0.75,'team':0.5,'call':0.65,'need':0.45, 'contact':0.8,'correct':0.8,'how':0.95, 'request':0.75,'improve':0.6,'add':0.7,'please':0.6,'want':0.65,'should':0.3,'wish': 0.75,'software': 0.7},
