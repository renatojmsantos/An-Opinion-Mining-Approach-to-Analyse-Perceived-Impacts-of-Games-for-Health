...
dictVocabulary={	
	...
	'Enchantment': {'enchantment': 1.0, 'concentration': 0.9,'love': 0.8,'clapping':0.6,'attention': 0.9,'hearts':0.6,'liveliness': 0.7,'pleasure': 0.85,'disorientation': 0.7,'experience': 0.6},
	
	'Engagement': {'engagement': 1.0, 'enjoyable':0.9,'experience':0.7,'challenge': 0.95, 'flow': 1.0,'skill': 0.95,'forget': 0.7,
				'addict': 0.9, 'addition': 1.0, 'replay':0.8,'fun':0.8, 'dancing':0.65, 'nonstop': 0.9, 'lyric':0.85,'soundtrack':0.9,'sing':0.85,'hardest':0.6,
	...
	'Motivation': {'motivation': 1.0, 'dance':0.5, 'inspiring':0.7,'workout':0.7, 'exercising':0.8,'curiosity': 0.65,'competition': 0.6,'joy': 0.5,'pleasure':0.65},
	...
	'Energy': {'energy': 1.0, 'alive': 0.6, 'endurance': 0.8, 'sweat':0.75, 'hyperactivy':0.8,'calories':0.9, 'stamina':0.85, 'vitality':0.8, 'animation':0.75,'exercise':0.8, 'exercising':0.9, 'strong':0.75,'enthusiasm': 0.75, 'dance':0.65, 'workout':0.9},
	...
	'Learning': {'cognitive': 0.6, 'school': 0.6,'knowledge': 0.55,'teach': 0.70,'concentration':0.4,'memory':0.4,'thinking':0.4, 'dyscalculia': 0.7,
	...
	'Pain and Discomfort': {'pain': 1.0, 'discomfort': 1.0,'worthlessness': 0.7,'depression': 0.77,'vomit':0.7, 'sad': 0.8,'grief': 0.8,'distress': 0.9,'panic': 0.8,'sore':0.75, 'sneezing':0.7, 'nauseated':0.7,
						'fracture': 0.65,'cramp': 0.75,'injury': 0.8,'toothache': 0.9,'bingeing':0.7,'bulimarexia':0.7,'headache': 0.9,'ache': 0.9,'disorder':0.75,'stiffness': 0.9,'drug': 0.75,
						'unpleasant': 0.8}, 
	
	'Personal relationships': {'personal': 1.0, 'homosexual': 0.7,'relationship': 0.85,'talking': 0.8,'heterosexual': 0.7,'marriage': 0.7,'friendship': 0.8,'hug': 0.8,
	...
	'Positive feelings': {'positive': 0.6, 'feeling': 0.6,'optimism': 0.8,'contentment': 0.7,'euphoria': 0.8,'enthusiastic': 0.7,'admiration': 0.7,'confidence': 0.8,'affection': 0.7,'relief': 0.8,
						...
						'love': 0.8,'fun': 0.8,'enjoyment': 0.8,'relax':0.7,'calm':0.7, 'grinning':0.70,'happy': 0.8,'peace': 0.75},
	...
	'Thinking': {'think': 1.0,'aware': 0.8,'awake': 0.8,'cognitive': 0.7,'reminds':0.6,'concentration':0.6,'memory':0.4,'learning':0.6,'echolalia': 0.7,'distractible':0.7, 'speech': 0.7,'alogia': 0.75,'thinking': 0.85,
				'idea': 0.65,'thought': 0.8,'decision': 0.6},
