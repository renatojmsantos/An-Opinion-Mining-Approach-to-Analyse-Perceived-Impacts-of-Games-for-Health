...
dictVocabulary={	
	...
	'Satisfaction': {'satisfaction':1.0,'happy': 0.8, 'fun': 0.9, 'great': 0.6, 'excellent':0.9,'good':0.5, 'love': 0.9, 'awesome':0.9,'wonderful':0.9,'worth': 0.8, 'best': 0.7, 'recommend': 0.7, 
					...
					'lack': 0.7,'unfortunate': 0.7,'well': 0.6,'fantastic': 0.8,'improve': 0.3,'price': 0.2, 'grinning':0.70,'smiling':0.62,'interest': 0.35,'fan': 0.2},
	...
	'Engagement': {'engagement': 1.0, 'enjoyable':0.8,'stop':0.1,'communicate':0.5,'correct':0.5,'connect':0.4,'improve':0.6,'experience':0.8,'challenge': 0.9, 'flow': 1.0,'skill': 1.0,'need': 1.0,'forget': 1.0,
				'addict': 0.9, 'addition': 1.0, 'replay':0.7, 'nonstop': 0.9, 'lyric':0.85,'sing':0.85,'most':0.5,'interest':0.6,'become':0.6,'gripper':0.6,'hardest':0.6,'painstaking':0.6,'intense':0.6,'hard':0.5,'tire':0.5,'engagement':0.6,
				'impossible':0.6,'keep':0.6,'therefore':0.6,
				'deep':0.6,'value':0.6,'tought':0.6,'easy':0.6,'complex':0.6,'moment':0.6,'hearts':0.6, 'harder':0.6,'depth':0.6,'hour':0.6,'difficult':0.6,'addict':0.6,'interest':0.7},
	...
	'Pain and Discomfort': {'pain': 1.0, 'discomfort': 1.0,'sore throat': 0.8,'sneezing':0.7, 'vomiting':0.7,'nauseated':0.7,'cramp': 0.9,'bone fracture': 0.9,'muscle cramp': 0.9,'toothache': 0.9,'headache': 0.9,'ache': 0.9,'stiffness': 0.9,'drug': 0.8,
						'distress': 0.8,'unpleasant': 0.8}, 
