...
dictVocabulary={	
	...
	'Enjoyment and Fun': {'enjoyment': 1.0, 'communicate':0.2,'easy':0.1,'cool':0.7,'wow':0.4,'awesome':0.6,'grinning':0.70,'hope':0.1,'spectacular':0.5,'happy':0.5,'hedonic': 0.9,'emotion': 0.7,'affect': 0.7,'fun': 1.0, 'young': 0.2, 
						...
						'lighter':0.2,'grin':0.2,'sooth':0.3,'excit':0.7,'laugh':0.6,'laughing':0.73,'humor':0.6,'amus':0.6,'love':0.6,'funniest':0.6},
	...
	'Pleasure': {'pleasure': 1.0, 'fun': 0.8, 'moneybag':0.35, 'enjoy': 0.7, 'love': 0.7, 'entertain': 0.7, 'awesome': 0.8, 'stimulation':0.5, 'felt': 0.6, 'sooth': 0.7, 'adict': 0.7, 'countless': 0.5,'everytim': 0.5,'perpetu': 0.5,
				...
				'workout': 0.6,'lighter': 0.4,'sooth': 0.3,'annoy': 0.7,'boredom': 0.7,'laughing':0.7,'nostalgia': 0.65},
	...
	'Bodily image and Appearance': {'bodily':1.0, 'image': 0.55, 'appearance': 1.0, 'anorexia':0.8, 'anorexic':0.8, 'handicapped': 0.75,'physical': 0.9,'self-concept': 0.9,'body': 0.95,'limb': 0.6,'artificial': 0.5,
									...
									'look': 0.35, 'fat':0.9,'beard':0.50 ,'skinny':0.9, 'workout':0.6,'exercising':0.6, 'weight':0.8},
	...
	'Energy': {'energy': 1.0, 'alive': 0.3, 'endurance': 0.8,'sinchonized':0.35, 'calories':0.9, 'exercise':0.8, 'exercising':0.9, 'strong':0.7,'enthusiasm': 0.67, 'sedentary':0.35, 'dancing':0.67, 'workout':0.9},
