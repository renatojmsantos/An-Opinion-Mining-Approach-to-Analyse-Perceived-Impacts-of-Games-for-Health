...
dictVocabulary={	
	...
	'Affect and Emotion': {'affect': 1.0, 'emotion': 1.0, 'fearless':0.7, 'scarier':0.8, 'cry': 0.8,'sadness':0.7, 'hate': 0.8,'trust': 0.75,'surprise': 0.8,'fear': 0.8,'disgust': 0.8,'frustration': 0.8,'anger': 0.8,
						...
						'chore': 0.4,'lighter': 0.3,'grin': 0.4,'fell': 0.7,'felt': 0.7,'laugh':0.7,'sooth': 0.7,'humor': 0.7,'grin':0.70,'love': 0.8},
	...
	'Engagement': {'engagement': 1.0, 'enjoyable':0.9,'experience':0.7,'challenge': 0.95, 'flow': 1.0,'skill': 0.95,'forget': 0.7,
				'addict': 0.9, 'addition': 1.0, 'replay':0.8,'fun':0.8, 'dance':0.5, 'nonstop': 0.9, 'lyric':0.85,'soundtrack':0.9,'sing':0.85,'hardest':0.6,
	...
	'Enjoyment and Fun': {'enjoyment': 1.0, 'awesome':0.6,'grin':0.70,'happy':0.7,'hedonic': 0.9,'emotion': 0.7,'affect': 0.7,'fun': 1.0,  
						'entertain': 0.9, 'grin':0.7,'humor': 0.7,'excit':0.7,'laugh':0.75,'love':0.75},
	...
	'Impact': {'impact': 1.0, 'pattern': 0.6, 'wow':0.4,'surprise': 0.8,'gameplay': 0.9, 'change': 0.6},
	...
	'Motivation': {'motivation': 1.0, 'dance':0.55, 'inspiring':0.7,'workout':0.7, 'exercise':0.8,'curiosity': 0.65,'competition': 0.6,'joy': 0.5,'pleasure':0.65},
	...
	'Concentration': {'aware': 0.8,'awake': 0.75,'alert': 0.8,'performance': 0.6,'think':0.55,'memory':0.4,'distractible':0.7,'learn':0.4,'insomnia': 0.8,'focus': 0.8,'pressure': 0.65,'insomnia': 0.8,'epilepsy': 0.8,'dementia': 0.8,
					'alcohol': 0.7,'attention': 0.9, 'cognitive': 0.7, 'synchronized':0.65,'choreography':0.7,'concentration': 1.0},
	
	'Energy': {'energy': 1.0, 'alive': 0.6, 'endurance': 0.8, 'sweat':0.75, 'hyperactivy':0.8,'choreography':0.7,'calorie':0.9, 'stamina':0.85, 'vitality':0.8, 'animation':0.75,'exercise':0.8, 'strong':0.75,'enthusiasm': 0.75, 'dance':0.55, 'workout':0.9},
	
	'Fatigue': {'fatigue': 1.0, 'overexertion': 0.8, 'depression': 0.8, 'cramps':0.75, 'vomit':0.75, 'panic':0.65,'weariness': 0.8, 'anorexia':0.8, 'disorder':0.7,'anxiety': 0.8,'sedentary':0.65,'stress': 0.75, 'disease': 0.95, 'illness': 0.8,'tire': 0.55,'tired': 0.9, 'exhaustion': 0.8},
	
	'Learning': {'cognitive': 0.6, 'school': 0.6,'knowledge': 0.55,'teach': 0.70,'concentration':0.4,'memory':0.4,'think':0.4, 'dyscalculia': 0.7,
				'dysgraphia': 0.6,'dyslexia': 0.6,'pedagogy': 0.55, 'learn': 1.0},
	
	'Memory': {'forget': 0.8, 'alzheimer': 0.8, 'old': 0.75, 'reminds': 0.85, 'dementia': 0.8,'parkinson': 0.8,'korsakoff': 0.8,'huntington': 0.8,'autism': 0.8,'nostalgia':0.9, 'remember':0.85, 'memory': 1.0, 'cognitive': 0.7},
	...
	'Personal relationships': {'personal': 1.0, 'homosexual': 0.7,'relationship': 0.85,'talk': 0.8,'heterosexual': 0.7,'marriage': 0.7,'friendship': 0.8,'hug': 0.8,
							'intimate': 0.7,'love': 0.6,'support': 0.65,'people': 0.65,'who':0.65,'kiss':0.65,'everybody':0.65, 'partner':0.8, 'partnership': 0.8,'share':0.7 ,'moments': 0.55,'companionship': 0.75,'friend': 0.9, 'family': 0.9, 'alone': 0.9},
	...
	'Self-esteem': {'self':1.2, 'esteem': 0.98, 'self-esteem':1.0,'meaningful': 0.9,'anxiety': 0.8,'guilt': 0.8,'despondency': 0.8,'depression': 0.9,'tearfulness': 0.8, 'regret': 0.8, 'appearance':0.85,'shame': 0.8,'enthusiastic':0.78,
				...
				'admiration': 0.8,'prestige': 0.8, 'wellbeing': 0.9,'ashamed': 0.9,'guilty': 0.9,'fat':0.73,'ugly':0.75,'worthless': 0.8,'think':0.45,'regard': 0.8,'alone':0.7, 'respect': 0.75, 'competence': 0.65,'belong': 0.65,'identity': 0.65,'security': 0.6,
	...
	'Thinking': {'think': 1.0,'aware': 0.8,'awake': 0.8,'cognitive': 0.7,'reminds':0.6,'concentration':0.6,'memory':0.4,'learn':0.6,'echolalia': 0.7,'distractible':0.7, 'speech': 0.7,'alogia': 0.75,
