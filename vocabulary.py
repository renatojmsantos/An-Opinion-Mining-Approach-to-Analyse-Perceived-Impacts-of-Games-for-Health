...
dictVocabulary={	
	...
	'Learnability': {'learn': 0.85, 'intuit': 0.9, 'ability':0.65,'easy': 0.7,'straightforward': 0.75,'foreword': 0.75, 'applet':0.7,'smooth':0.6, 'master':0.6, 
					'experiment':0.65, 'simple':0.6, 'practice': 0.65}, 
	
	'Memorability': {'memorability':0.8,'memory': 1.0, 'forgot': 0.8, 'remind':0.8}, 
	
	'Satisfaction': {'satisfaction':1.0,'bad': 0.95, 'happy': 0.8, 'fun': 0.9, 'great': 0.7, 'excellent':0.9,'good':0.7, 'disgust':0.65, 'love': 0.56, 'pleasure':0.6,'awesome':0.9,'wonderful':0.9,'worth': 0.8, 'recommend': 0.6, 
					'favorite': 0.8, 'cool': 0.6, 'reliable':0.8,'perfect': 0.9,'disappoint': 0.7,'quality': 0.7,
	...
	'Hedonic': {'hedonic': 1.0, 'fun': 0.9, 'superb':0.8,'enjoy': 0.8, 'social':0.7,'memory':0.65,'beauty':0.9,'excitement':0.9, 'love':0.6,'awesome':0.8,'friend':0.65,'ergonomic': 0.7, 
	...
	'Support': {'support':1.0, 'help':0.95, 'service':0.9,'want':0.75,'customer':0.66,'FAQ':0.8,'contact':0.8,'correct':0.7, 
				'request':0.85,'improve':0.85,'add':0.9,'lack': 0.9,'need':0.7,'fix':0.8,'please':0.6,'want':0.75,'should':0.85,'wish': 0.85,'software': 0.7},
	
	'Trust': {'trust': 0.95, 'behavior': 0.7, 'disappoint':0.8, 'quality':0.7, 'belief':0.8, 'reliance':0.8,'reliability':0.8,'reliable':0.8,'secure':0.8},
	
	'User Differences': {'user':0.75, 'social':0.63,'group': 0.6,'head-to-head':0.8,'beginner':0.9, 'experience':0.8, 'multiplayer':0.65, 'device':0.8,'country':0.8,'console':0.8,'platform':0.7,
						'previous':0.8,'veteran':0.9,'pro':0.8, 'feature':0.8,'player':0.7, 'amateur':0.9,
	...
	'Energy': {'energy': 1.0, 'alive': 0.6, 'endurance': 0.8, 'sweat':0.75, 'play':0.6,'hyperactivy':0.8,'choreography':0.7,'calorie':0.9, 'stamen':0.70, 'vitality':0.8, 'animation':0.75,'exercise':0.8, 'strong':0.75,'enthusiasm': 0.75, 
			'dance':0.76, 'workout':0.9},
	
	'Fatigue': {'fatigue': 1.0, 'overexertion': 0.8, 'depression': 0.8, 'cramp':0.75, 'vomit':0.75, 'panic':0.65,'weariness': 0.8, 'anorexia':0.8, 'disorder':0.7,'anxiety': 0.8,'sedentary':0.65,'stress': 0.75, 'disease': 0.95, 'illness': 0.8,'tire': 0.8,
				'exhaustion': 0.8},
	
	'Learning': {'cognitive': 0.57, 'school': 0.6,'teach': 0.70,'concentration':0.56,'think':0.56, 'dyscalculia': 0.7, 'dysgraphia': 0.6,'dyslexia': 0.6,'pedagogy': 0.6, 'learn': 1.0},
	
	'Memory': {'memory': 1.0, 'forget': 0.8, 'alzheimer': 0.8, 'memorize':0.9,'remember':0.9,'old': 0.75, 'remind': 0.85, 'dementia': 0.8,'parkinson': 0.8,'korsakoff': 0.8,'huntington': 0.8,'autism': 0.8,'nostalgia':0.9, 'remember':0.85, 'cognitive': 0.7},
	
	'Negative feelings': {'negative':0.6, 'feel': 0.6, 'regardless': 0.56,'despair': 0.8,'apathy': 0.8,'regret': 0.8, 'disapproval': 0.8,'agressiveness': 0.8,'remorse': 0.8,'contempt': 0.8,'disgust': 0.8,'annoy': 0.8,'shame': 0.8,'sad': 0.8,
						'cry': 0.8,'depression': 0.9,'distress': 0.9,'frustration': 0.9, 'depress':0.9,
	...
	'Personal relationships': {'personal': 1.0, 'social':0.6,'homosexual': 0.7,'relationship': 0.85,'heterosexual': 0.7,'marriage': 0.7,'friendship': 0.8,'hug': 0.8,
							'intimate': 0.7,'multiplayer':0.65,'talk':0.6,'mentor':0.7,'sister':0.9,'father':0.9,'colleague':0.8,'sympathy':0.7,'support': 0.65,'people': 0.65,'kiss':0.65,'everybody':0.65,
							 'partner':0.8, 'partnership': 0.8,'share':0.7,'love':0.7,'cousin':0.85,'someone':0.65,'roommate': 0.95,'heart':0.8, 'intimacy':0.7, 'together':0.8,'companionship': 0.75,'friend': 0.9, 'family': 0.9, 'alone': 0.9},
	
	'Positive feelings': {'positive': 0.6, 'feel': 0.6,'optimism': 0.8,'contentment': 0.7,'euphoria': 0.8,'enthusiastic': 0.7,'admiration': 0.7,'confidence': 0.8,'affection': 0.7,'relief': 0.8,
	...
	'Sleep and Rest': {'sleep': 1.0,'wake':0.85, 'parasomnia': 0.8,'night':0.7,'hypersomnia': 0.8,'yawn':0.7, 'nightmare':0.8, 'restless':0.65, 'apnea': 0.8,'insomnia': 0.8,'refreshment': 0.6,'rest': 1.0},
	
	'Social support': {'social':1.0, 'support': 0.90, 'ask':0.6, 'share': 0.6,'teach': 0.85,'companionship':0.9,'empathy':0.9,'sympathy':0.9,'esteem':0.8,'solve': 0.65,'relationship': 0.95,
					'handshake':0.6,'roommate': 0.95, 'thanks': 0.6,'inclusive':0.7, 'help': 0.9,'chill': 0.6,'dude': 0.6,'friend': 0.9,'abuse': 0.6,
					'personal': 0.6,'crisis': 0.6, 'care':0.65, 'group':0.7,'mentor':0.7,'collab':0.7,'save':0.65,'sister':0.9,'father':0.9,'sympathy':0.7,'community':0.75,'suggestion':0.75, 'encourage':0.75, 'advice':0.85, 
					'assistance': 0.85,'together':0.8,'kiss': 0.65,'cousin':0.85,'family': 0.9},
