...
dictVocabulary={	
	...
	'Efficiency': {'efficiency': 1.0, 'perfect': 0.65,'speed':0.7, 'load':0.8,'useful':0.7,'performance':0.7, 'experience':0.65,'difficult':0.75,'lock':0.56,'prompt':0.8,'slow':0.9,'limit':0.7, 'fast':0.9, 'ability':0.7,'work': 0.7, 'well':0.58}, 
	...
	'Comfort': {'comfort': 1.0, 'problem':0.65,'physical': 0.7, 'workout': 0.65, 'fit':0.56, 'ergonomic': 0.85, 
	...
	'Detailed Usability': {'usability': 1.0, 'problem': 0.95, 'reliable':0.7,'convenient':0.7,'viewable':0.7,'awkward':0.8,'useful':0.8,'efficient':0.8,'effective':0.8, 'broken': 0.8,'camera': 0.75, 
					'lag': 0.9,'bug': 0.9, 'delay':0.9, 'glitch': 0.8,'performance':0.96, 'latency':0.8, 
	...
	'Enchantment': {'enchantment': 1.0, 'concentration': 0.9,'love': 0.8,'clap':0.6,'attention': 0.9,'heart':0.6,'liveliness': 0.7,'pleasure': 0.85,'disorientation': 0.7,'experience': 0.6},
	...
	'Motivation': {'motivation': 1.0, 'dance':0.56, 'inspire':0.7,'workout':0.7, 'exercise':0.8,'curiosity': 0.65,'competition': 0.8,'joy': 0.56,'pleasure':0.65},
	...
	'Support': {'support':1.0, 'help':0.85, 'service':0.7,'customer':0.6,'FAQ':0.6,'contact':0.8,'correct':0.7, 
				'request':0.75,'improve':0.65,'add':0.8,'lack': 0.7,'need':0.56,'fix':0.6,'please':0.6,'want':0.65,'should':0.65,'wish': 0.75,'software': 0.7},
	...
	'Learning': {'cognitive': 0.6, 'school': 0.6,'knowledge': 0.56,'teach': 0.70,'concentration':0.56,'think':0.56, 'dyscalculia': 0.7,
	...
	'Pain and Discomfort': {'pain': 1.0, 'discomfort': 1.0,'worthlessness': 0.7,'depression': 0.77,'vomit':0.7, 'sad': 0.8,'grief': 0.8,'distress': 0.9,'panic': 0.8,'sore':0.75, 'sneeze':0.7, 'nauseate':0.7,
	...
	'Personal relationships': {'personal': 1.0, 'social':0.6,'homosexual': 0.7,'relationship': 0.85,'heterosexual': 0.7,'marriage': 0.7,'friendship': 0.8,'hug': 0.8,
							'intimate': 0.7,'multiplayer':0.65,'talk':0.6,'mentor':0.7,'colleague':0.8,'sympathy':0.7,'support': 0.65,'people': 0.65,'kiss':0.65,'everybody':0.65,
							 'partner':0.8, 'partnership': 0.8,'share':0.7,'love':0.56,'roommate': 0.95,'heart':0.8, 'intimacy':0.7, 'together':0.8,'companionship': 0.75,'friend': 0.9, 'family': 0.9, 'alone': 0.9},
	...
	'Social support': {'social':1.0, 'support': 0.90, 'ask':0.6, 'share': 0.6,'teach': 0.85,'companionship':0.9,'empathy':0.9,'sympathy':0.9,'esteem':0.8,'solve': 0.65,'relationship': 0.95,
					...
					'personal': 0.6,'crisis': 0.6, 'care':0.65, 'group':0.7,'mentor':0.7,'collab':0.7,'sympathy':0.7,'community':0.75,'suggestion':0.75, 'encourage':0.75, 'advice':0.85, 
